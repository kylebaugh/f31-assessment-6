...
const drawFive = () => {
    axios.get('http://ec2-35-90-150-34.us-west-2.compute.amazonaws.com/api/robots/five')
        .then(res => {
...
const duel = () => {
    ...
    setTimeout(() => {
        axios.post('http://ec2-35-90-150-34.us-west-2.compute.amazonaws.com/api/duel', {compDuo, playerDuo})
            .then(({data}) => {
...
const getPlayerStats = () => {
    axios.get('http://ec2-35-90-150-34.us-west-2.compute.amazonaws.com/api/player')
...
const getAllBots = () => {
    axios.get('http://ec2-35-90-150-34.us-west-2.compute.amazonaws.com/api/robots')
        .then(({data}) => {
